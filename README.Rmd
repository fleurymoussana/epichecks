...
One folder which contains an R-project file (e.g. WHO_AFRO.Rproj) and a Data folder. 
Within the data folder you need a processed folder, which contains IDSR data,
and an outputs folder which contains another folder called Verification. 
Within verification the function will create a folder for each week and place
outputs files in there. 
...
## load image of folder structure
knitr::include_graphics(system.file("extdata", "folder_layout.png", package = "epichecks"))
```
