...
for (i in levels(current_weeks)) {

  ## pull together name of threshold count variable for week
  thresh_var <- str_glue("threshold_counts_{i}")
  ...
  disease_var <- str_glue("disease_counts_{i}")
  
  ## create categorical variable out of threshold_counts for week
  afro_shp[[disease_var]] <- cut(afro_shp[[disease_var]],
           breaks = c(0, 0.1, 1, 2, 3, 4, Inf),
           include.lowest = TRUE,
