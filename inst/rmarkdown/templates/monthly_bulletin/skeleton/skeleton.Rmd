...
**Figure 7**: Distribution of cases and CFR by week for 
...
**Figure 8**: Distribution of cases by country and week for 
`r length(unique(cholera_outbreak_data$country))` countries experiencing a 
cholera outbreak in the African region
...
**Figure 9**: Spatial distribution of cumulative cholera cases and CFR by country
