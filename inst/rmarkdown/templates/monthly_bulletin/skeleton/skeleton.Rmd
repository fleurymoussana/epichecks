...
## drop the end of outbreak date variable as if all empty cannot fix dates
## (should be fixed by the newer version of linelist)
# phe_data <- phe_data %>% 
#   select(-end_of_outbreak_date)
